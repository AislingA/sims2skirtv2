...
from io.loader import load_snapshot, get_header_data, get_particle_data, filter_by_id
from io.transform import finalize_dataset
...
def run_pipeline(snapshot_path, percentage=1, verbose=True):
    ...
    try:
        ...
        # 3. Configurations
        template_path = 'src/config/template.ski'
